...
function reportMetrics (vitals, additionalMetrics, endpoint, getFIDLongTasks, longTaskWindow) {
...
function grabVitals (endpoint, additionalMetrics, getFIDLongTasks = true, longTaskWindow = 1000) {
